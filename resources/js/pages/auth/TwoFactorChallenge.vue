            ...
            <template v-if="!showRecoveryInput">
                ...
                >
                    ...
                    <div class="text-center text-sm text-muted-foreground">
                        ...
                        <button
                            type="button"
                            class="text-foreground underline decoration-neutral-300 underline-offset-4 transition-colors duration-300 ease-out hover:cursor-pointer hover:decoration-current! dark:decoration-neutral-500"
