...
const baseTargetCalories = computed(() => props.caloriesOverview.target_calories ?? 0);
...
const caloriesDelta = computed(() => editedCalories.value - baseTargetCalories.value);
const isCaloriesOverBase = computed(() => editedCalories.value > baseTargetCalories.value);
                    ...
                    <div class="space-y-4">
                        <div class="rounded-lg border border-neutral-200 bg-neutral-50 p-4">
                            <div class="flex items-center justify-between gap-3">
                                ...
                                <div class="rounded-full bg-white px-3 py-1 text-sm font-medium text-evo-purple">
                                    -800 kcal
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="rounded-lg border border-dashed border-neutral-300 p-4">
                            <p class="text-sm text-neutral-600">
                                Plus tard, cette zone permettra d'ajouter de vrais
                                aliments, de calculer automatiquement les calories
                                et d'actualiser la progression du jour.
                            </p>
                        </div>
                    </div>
                </div>
