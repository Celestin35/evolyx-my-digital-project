...
class CreateNewUser implements CreatesNewUsers
{
    ...
    public function create(array $input): User
    {
        Validator::make($input, [
            ...
            'weight.numeric' => 'Le poids doit etre un nombre.',
            'weight.min' => 'Le poids doit etre compris entre 20 et 600 kg.',
            'weight.max' => 'Le poids doit etre compris entre 20 et 600 kg.',
